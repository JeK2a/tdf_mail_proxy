...
class SMTP_PHPMailer
{
    ...
    private $proxy_smtp = null; // TODO jek2a

    public function __construct($proxy_smtp = null)
    {
        $this->smtp_conn = 0;
        $this->error = null;
        $this->helo_rply = null;
        ...
        $this->proxy_smtp = $proxy_smtp; // TODO jek2a
    }
...
//        echo $command."\n";
        ...
        if ($this->proxy_smtp === null) {
            ...
            $reply = $this->proxy_smtp->getLine(); // TODO JeK2a
        }
        ...
        if ($this->proxy_smtp !== null) { // TODO jek2a
    ...
    public function client_send($data)
    {
        ...
        if ($this->proxy_smtp === null) {
            $out = fwrite($this->smtp_conn, $data);
        } else {
            $out = $this->proxy_smtp->curl_telnet($data);
        }
